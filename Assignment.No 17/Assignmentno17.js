"use strict";
let guests = ["ali", "amna", "fatima", "alia"];
let whocantcook = "faha";
...
console.log(`Dear ${removedgueest2}I am sad to say that I would not call you for dinner in my home.\nAleeha Fatima.`);
console.log(`Dear ${guests} you will still come for dinner in my house.`);
let reomvedguests3 = guests.pop();
